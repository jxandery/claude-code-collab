...
echo ""
echo -e "  ${GREEN}start-collaboration.sh${NC}        Interactive setup wizard"
...
echo -e "  ${GREEN}list-sessions.sh${NC}              View active sessions"
echo -e "  ${GREEN}download-from-server.sh${NC}       Download files from server"
echo -e "  ${GREEN}setup-ssh.sh${NC}                  Set up or check SSH keys"
echo -e "  ${GREEN}add-collaborator.sh${NC}           Add a collaborator's SSH key"
echo -e "  ${GREEN}diagnose.sh${NC}                   Check if everything is working"
echo -e "  ${GREEN}teardown.sh${NC}                   Clean up sessions"
echo ""
echo -e "${BLUE}Quick start:${NC}"
echo "  For guided setup:    start-collaboration.sh"
echo "  For full docs:       See docs/ folder"
echo ""
